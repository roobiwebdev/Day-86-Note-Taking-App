      ...
      <div className="w-[440px] flex flex-col p-4 bg-white border border-neutral-200 dark:bg-slate-800 dark:border-slate-600 rounded-xl">
        ...
        <div className="flex flex-row gap-4 w-full pb-5 border-b border-b-neutral-200 dark:border-b-slate-600 shrink-0">
          ...
          <div className="flex flex-col items-start gap-2 w-3/4">
            <h1 className="text-base text-neutral-950 font-semibold dark:text-white">
              Delete All Notes
            </h1>
            <p className="text-sm dark:text-slate-300 text-neutral-700 font-normal">
              Are you sure you want to permanently delete all notes? This action
              cannot be undone.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end w-full gap-4 pt-5">
          <button
            className="bg-neutral-100 text-neutral-700 dark:bg-slate-500 dark:text-slate-300 font-medium text-center text-sm px-4 py-[10px] rounded-lg hover:bg-neutral-200"
